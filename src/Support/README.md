...
| `LocalUrl` | Builds only local, single-leading-slash links/redirects and rejects absolute, scheme-relative, control-character, malformed, encoded-separator, and traversal-shaped targets. |
