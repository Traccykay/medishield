...
| `lab_result_concurrency_worker.php` | Pre-connected, barrier-synchronized subprocess used to prove the database lab-result claim under real MariaDB contention. |
